...
class TestHeaders(TestCase):
    ...
    def test_get_header(self):
        ...
        for filename in glob.glob(os.path.join(vsc_setup.REPO_TEST_DIR, 'headers', "*.get_header")):
    ...
    def test_gen_license_header(self):
        ...
        for license in KNOWN_LICENSES.keys():
            res_fn = os.path.join(vsc_setup.REPO_TEST_DIR, 'headers', license)
    ...
    def test_check_header(self):
        ...
        for filename in glob.glob(os.path.join(vsc_setup.REPO_TEST_DIR, 'headers', "*.check")):
